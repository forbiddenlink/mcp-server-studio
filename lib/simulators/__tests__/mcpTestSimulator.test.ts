...
import type { MCPParameter, MCPPrompt, MCPResource, MCPTool } from '../../types'
import {
  executeTool,
...
describe('mcpTestSimulator', () => {
  describe('validateParameters', () => {
    ...
    it('validates date-time format', () => {
      ...
      expect(validateParameters({ dt: '2024-01-15T10:30:00Z' }, params)).toHaveLength(0)
    ...
    it('validates uri format', () => {
      ...
      expect(validateParameters({ url: 'https://example.com' }, params)).toHaveLength(0)
  ...
  describe('testPrompt', () => {
    ...
    it('formats content for code review prompts', () => {
      const prompt = makePrompt({
        ...
        arguments: [{ name: 'code', type: 'string', description: 'Code', required: true }],
      })
